...
| **pdf_options**   | `Object` | Customize PDF output with page size, margins, scale, and background printing. Use this when you plan to request the generated URL with a `.pdf` extension. [Learn more](/parameters/pdf_options/). |
