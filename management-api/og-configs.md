...
permalink: /management-api/og-configs/
...
{% include operation-cards.html resource="og-configs" %}
...
{% include additional_parameters.md context="og_config_management" include_primary=true %}
