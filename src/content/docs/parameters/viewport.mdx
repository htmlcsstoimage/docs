...
<a id="viewport-width-and-height" />
...
<Aside title="Responsive layouts">Choose viewport dimensions that match the breakpoint you want to capture. The width determines which CSS media queries and responsive styles are applied.</Aside>
