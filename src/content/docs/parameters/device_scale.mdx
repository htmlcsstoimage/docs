...
### Oversized images
If your image file size is larger than needed, consider reducing the device_scale. A scale of `2` doubles both dimensions and produces four times as many pixels; a scale of `3` produces nine times as many pixels.
...
Higher `device_scale` values increase both rendering time and file size. Use the lowest value that meets your quality requirements.
</Aside>
