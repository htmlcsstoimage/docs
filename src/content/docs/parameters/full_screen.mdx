...
For very long pages, consider whether you really need the full page. Using the [`selector`](/parameters/selector/) parameter to capture just a specific section is often faster and produces smaller files.
</Aside>
