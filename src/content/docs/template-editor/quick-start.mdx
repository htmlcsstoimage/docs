...
<DocImage src="/assets/images/template-editor/te-empty-editor.png" alt="Blank template editor with the block sidebar, empty canvas, and properties sidebar" />
