...
<LinkButton href="/getting-started/using-the-api/" variant="secondary">View API documentation</LinkButton>
<LinkButton href="/example-code/" variant="secondary">See example code</LinkButton>
