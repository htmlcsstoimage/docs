...
Manage this resource alongside your application with [Terraform](/management-api/terraform/#api-keys) or [Pulumi](/management-api/pulumi/#api-keys). See [infrastructure as code](/management-api/iac/) for application setups, credentials, and lifecycle behavior.
