...
Manage this resource alongside your application with [Terraform](/management-api/terraform/#og-configurations) or [Pulumi](/management-api/pulumi/#og-configurations). See [infrastructure as code](/management-api/iac/) for application setups, credentials, and lifecycle behavior.
