...
<a id="authentication-and-api-keys" />
...
<DocImage src="/assets/images/api-keys/create-key-simple.png" alt="Create an API key in the default simple view, with Read and Write permission groups for each resource area and the Basics preset selected." width={1272} height={802} caption="The default view groups permissions by area. Click the screenshot to view it full size." />
...
<DocImage src="/assets/images/api-keys/create-key-advanced.png" alt="Advanced mode in the API key form, showing separate Read, Create/Update, and Delete permissions, with Create and Store separated for Images." width={1269} height={802} caption="Advanced mode exposes individual actions instead of grouping all writes together." />
...
<DocImage src="/assets/images/api-keys/permission-details.png" alt="Expanded OG Configs permission details showing read and write descriptions and the permissions required for each Open Graph configuration endpoint." width={997} height={634} caption="Each area includes descriptions and an endpoint-to-permission reference." />
