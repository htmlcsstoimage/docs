...
<a id="using-the-htmlcss-to-image-api" />
...
<Aside title="Using Cursor, Claude, Codex or another AI tool?">Generate images without writing code using our [MCP Server integration](/integrations/mcp/).</Aside>
...
<Endpoint method="POST" path="/v1/image" />
...
<Endpoint method="GET" path="/v1/image/:image_id" />
...
<Aside title="Tip">You can include the desired format as a parameter when creating your image. See [file formats](/parameters/format/) for more details.</Aside>

<Aside title="PNG by default">The API returns `png` by default. If no extension is on the URL, a png will be generated.</Aside>
...
<DocImage src="https://hcti.io/v1/image/019b7577-ecda-7fb7-9179-26c4609288e1" alt="Original 600x400 image" width={300} />

**Crop to 1:1 square from center** (`aspect_ratio=1_1&crop_height=100%`):

<DocImage src="https://hcti.io/v1/image/019b7577-ecda-7fb7-9179-26c4609288e1?aspect_ratio=1_1&crop_height=100%25" alt="1:1 aspect ratio crop" width={300} />
...
<DocImage src="https://hcti.io/v1/image/019b7577-ecda-7fb7-9179-26c4609288e1?x_1=0&crop_width=33%25" alt="Left third crop" width={200} />
...
<DocImage src="https://hcti.io/v1/image/019b7577-ecda-7fb7-9179-26c4609288e1?x_1=33%&x_2=66%25" alt="Center third crop" width={200} />
...
<DocImage src="https://hcti.io/v1/image/019b7577-ecda-7fb7-9179-26c4609288e1?x_1=67%25&crop_width=33%25" alt="Right third crop" width={200} />
...
<DocImage src="https://hcti.io/v1/image/019b7577-ecda-7fb7-9179-26c4609288e1?aspect_ratio=16_9&crop_width=100%25" alt="16:9 aspect ratio crop" />
...
<Endpoint method="DELETE" path="/v1/image/:image_id" />
...
<Endpoint method="POST" path="/v1/image/batch" />
...
<Endpoint method="DELETE" path="/v1/image/batch" />
...
<Endpoint method="GET" path="/v1/images" />
