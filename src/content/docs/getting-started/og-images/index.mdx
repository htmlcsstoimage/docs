...
<a id="automatic-open-graph-images-for-every-page" />

Give every page on your site an up-to-date social card with one stable image URL pattern.

<LinkButton href="https://htmlcsstoimage.com/dashboard/og-configs/new">Create an OG Image Config</LinkButton>
<LinkButton href="https://htmlcsstoimage.com/tools/social-card-previewer" variant="secondary">Preview a page</LinkButton>
...
<Aside title="Parameter support">The dashboard provides the most common screenshot controls. See the [full list of supported `hcti:` page parameters](/getting-started/og-images/supported-parameters/) for every available page-level override.</Aside>
