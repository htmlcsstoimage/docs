...
<a id="bypassing-cloudflare-challenges-for-sites-you-control" />
...
<Aside title="Only for sites you control">Use this approach for a domain and Cloudflare account you own or administer.</Aside>
...
<Aside title="Other network issues">For problems involving the render's source IP, network access, or region, see [HTTP proxies](/guides/advanced/proxies/).</Aside>
