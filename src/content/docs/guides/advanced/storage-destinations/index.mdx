...
<Aside title="This setting is captured per image">Changing **Disable HCTI Storage** affects only images created afterward. Existing images keep the storage behavior selected when they were created.</Aside>
