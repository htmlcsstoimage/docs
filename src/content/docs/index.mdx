...
<div className="generation-grid grid grid-cols-[repeat(auto-fit,minmax(min(100%,25rem),1fr))] gap-6 [&>*]:mt-0!">
<ExampleCard
  id="from-htmlcss"
  title="From HTML/CSS"
...
| **Use with AI assistants**     | Connect [Claude & Claude Code](/integrations/mcp/claude/), [Codex & ChatGPT](/integrations/mcp/chatgpt-codex/), [Cursor](/integrations/mcp/cursor/), [Grok](/integrations/mcp/grok/), [and more](/integrations/mcp/) via MCP                                                                                                                                                                                                                                                                                                 |
