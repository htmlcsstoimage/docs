...
<a id="social-cards-and-open-graph-images" />
...
<DocImage src="/assets/images/image%20%2823%29.png" alt="Dev.to social card generated from HTML" />
...
```bash
curl -X POST https://hcti.io/v1/image/t-your-template-id -u 'UserID:APIKey' \
  -H "Content-Type: application/json" \
  -d '{
    "template_values": {
