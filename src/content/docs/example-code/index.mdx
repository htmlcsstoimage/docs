...
<Aside title="Using an AI coding assistant?">Connect our [MCP server](/integrations/mcp/) to generate images from your coding assistant.</Aside>
...
<Aside title="Required parameters">† Send `html` or `url`. CSS is optional.</Aside>

### Rendering options

<ParameterTable context="api" />
